_base_ = [
    ...
    '../../../_base_/datasets/solafune_cardet_rtmdet_s_1280.py',
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            project='solafune_cardet', name='rtmdet_s_solafune_cardet'),
        define_metric_cfg={'coco/bbox_mAP': 'max'})
]
visualizer = dict(vis_backends=vis_backends)

load_from = 'https://download.openmmlab.com/mmdetection/v3.0/rtmdet/rtmdet_s_8xb32-300e_coco/rtmdet_s_8xb32-300e_coco_20220905_161602-2724601d.pth'  # noqa
