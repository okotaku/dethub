    ...
    class COCOeval_optfix(COCOeval_opt):
        ...
        def summarize(self):
            ...
            def _summarizeDets():
                ...
                stats[1] = _summarize(
                    1, iouThr=.5, maxDets=self.params.maxDets[2])
                stats[2] = _summarize(
...
class CocoFastMetric(CocoMetric):
    ...
    def compute_metrics(self, results: list) -> Dict[str, float]:
        ...
        for metric in self.metrics:
            ...
            if COCOeval_optfix is None:
                raise ValueError('Please install detectron2 first.')
